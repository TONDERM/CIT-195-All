...
namespace Customers_Ch25_PA_11_
{
    public class ViewModel : INotifyPropertyChanged
    {
        ...
        public ViewModel() 
        {
            ...
            this.PreviousCustomer = new Command(this.Previous, () => this.customers.Count > 1 && !this.IsAtStart);
        ...
        {
            get => this.customers.Count > 0 ? this.customers[this.currentCustomer] : null;
        }
        ...
        private void Previous()
        {
            if (this.currentCustomer > 0)
            {
                ...
                this.OnPropertyChanged(nameof(Current));
                this.IsAtStart = false;
                this.IsAtEnd = (this.currentCustomer == 0);
            }
        }
    }
}
