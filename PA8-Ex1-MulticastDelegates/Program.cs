namespace assignment8ex1
{
    class Program
    {
        ...
        {
            SongDelegate Lyrics = new SongDelegate(HereComesTheSun.chorus);
            Lyrics += HereComesTheSun.verse1;
            Lyrics += HereComesTheSun.chorus;
            Lyrics += HereComesTheSun.verse2;
            Lyrics += HereComesTheSun.chorus2;
            Lyrics += HereComesTheSun.verse3;
            Lyrics += HereComesTheSun.chorus;
            Lyrics += HereComesTheSun.chorus;
            Lyrics += HereComesTheSun.end;
            Lyrics();
